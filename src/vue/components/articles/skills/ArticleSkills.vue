        ...
        <div class="article-content-wrapper">
            ...
            <div class="items-row-wrapper" :class="chartType ? `items-row-wrapper-with-chart` : ``">
                <div class="row" :class="`${gutterClass}`">
                    <ArticleSkillsItem v-for="(item, index) in props.model.items" :key="index"
                                       :item="item"
                                       ...
                                       :progress-bar-allowed="!chartType" style="align-items: center;"/>
                </div>
            </div>
        </div>
    </Article>
...
const colClass = computed(() => {
    switch (maxItemsPerLine.value) {
        ...
        case 2: return 'col-12 col-sm-4 col-lg-12 col-xl-4'
        case 3: return 'col-12 col-sm-4 col-xxl-4'
    }
})
...
const colClassWithChart = computed(() => {
    switch (maxItemsPerLine.value) {
        default: return 'col-12'
        case 2: return 'col-12 col-sm-4 col-xl-12 col-xxl-12'
        case 3: return 'col-12 col-sm-4 col-xxl-4'
    }
})
</script>
