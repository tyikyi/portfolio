<template>
    <li class="timeline-item"
        ...
        <ArticleTimelineItemContent v-if="item"
                                    ...
                                    :formatted-date-start="getYear(props.item.dateStart)"
                                    :formatted-date-end="getYear(props.item.dateEnd)"
...
const getYear = (dateValue) => {
   ...
   let year = new Date(dateValue).getFullYear().toString();
  return current_year !=  year ? year : "Present" ;
};
</script>
